...
public class SlidingDrawer extends ViewGroup {
    ...
    private static final int ANIMATION_FRAME_DURATION = 2000 / 60;
    ...
    private void moveHandle(int position) {
        ...
        if (mVertical) {
            ...
            if (position == EXPANDED_FULL_OPEN) {
                ...
                handle.offsetLeftAndRight(mBottomOffset + getWidth() -
                ...
                } else if (deltaX > mBottomOffset + getWidth() - mHandleWidth - left) {
                    deltaX = mBottomOffset + getWidth() - mHandleWidth - left;
                }
    ...
    private void closeDrawer() {
        ...
        ((ImageButton)mHandle).setImageResource(R.drawable.ic_collapse);
    ...
    private void openDrawer() {
        ...
        ((ImageButton)mHandle).setImageResource(R.drawable.ic_expand);
